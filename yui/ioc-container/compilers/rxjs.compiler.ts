...
import { IRxjsInterceptor, RxjsCommands, RxjsHandler, Type } from '../interfaces'
import { BaseRecursiveCompiler } from './base-recursive.compiler'

/**
 * @description Compile using Rxjs strategy.
 */
export class RxjsRecursiveCompiler extends BaseRecursiveCompiler<RxjsHandler, RxjsCommands> {
  constructor(
  ...
  protected compileCommand(target: Type<any>, instance: InstanceType<Type<any>>, propertyKey: string): RxjsHandler {
